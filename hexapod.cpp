...
: servocontroller1 {servocontroller1},
  servocontroller2 {servocontroller2},
  servos {
  ...
  legs {
    Leg { servos[0],  servos[1],  servos[2], 8.5f, (uint16_t)62,  Pointf {15,8,0}},
    Leg { servos[3],  servos[4],  servos[5], 6.5f, (uint16_t)0,   Pointf {0,14,0}},
    Leg { servos[6],  servos[7],  servos[8], 8.5f, (uint16_t)298, Pointf {-15,8,0}},
    Leg { servos[9], servos[10], servos[11], 8.5f, (uint16_t)242, Pointf {-15,-8,0}},
    Leg {servos[12], servos[13], servos[14], 6.5f, (uint16_t)180, Pointf {0,-14,0}},
    Leg {servos[15], servos[16], servos[17], 8.5f, (uint16_t)118, Pointf {15,-8,0}}
  }
{
  this->servocontroller1.begin();
  this->servocontroller1.setPWMFreq(50);
  this->servocontroller2.begin();
  this->servocontroller2.setPWMFreq(50);
}
